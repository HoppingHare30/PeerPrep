...
export default function SignupFormClient() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    // Client-side quick check for whitelisted email format
    ...
    try {
      ...
      if (error) {
        ...
        toast.success('Verification link sent! Please check your email.', { id: toastId });
      ...
      <form className="space-y-4" onSubmit={handleSignup}>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-text-secondary">
            *Must be a whitelisted college email address.
          </p>
        </div>
